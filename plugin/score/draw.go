...
func customtext(a *scdata, fontdata []byte, cw, ch, aw float64, textcolor color.Color) (img image.Image, err error) {
	...
	// canvas.DrawStringAnchored("Created By ZeroBot-Plugin "+banner.Version, 0+4, ch, 0, -0.5)
	canvas.DrawStringAnchored("Designed By FloatTech. Generated By NoyuBot", 0+4, ch, 0, -0.5)
